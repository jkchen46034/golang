...
func Signin(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		log.Println("unable to decode credentials")
	...
	if !ok || expectedPassword != creds.Password {
		...
		log.Println("credis password does not match, ", creds.Username)
		fmt.Println(w, "credits password does not match, ", creds.Username)
		return
	}
